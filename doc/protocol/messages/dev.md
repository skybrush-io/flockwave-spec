...
Name | Required? | Type | Description
---- | --------- | ---- | -----------
`devices` | no | object | Object mapping UAV IDs to the corresponding device trees. The structure of this object is described by the [`DeviceTreeNode`](../types.md#devicetreenode) complex type.
