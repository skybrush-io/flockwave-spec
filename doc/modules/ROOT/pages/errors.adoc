...
|75  |DRIFT   |Drift from desired position is large. This warning appears when
the drone deviates from its desired trajectory more than normal operation allows.
