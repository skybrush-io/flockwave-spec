...
|142 |ESC |ESC error. Use this error code for ESC-related errors such as an unusually
high error rate reported by the ESC (if this information is available).
...
|253 |SIMCRIT |Simulated critical error. Use this error code to trigger an
