...
|===
|Name |Required? |Type |Description
|lat |yes |float |The latitude, in 10^-7^ degrees, in the range [-90 × 10^7^, 90 × 10^7^)
|lon |yes |float |The longitude, in 10^-7^ degrees, in the range [-180 × 10^7^,180 × 10^7^)
|amsl |no |float |The altitude, in millimeters, above mean sea level
|agl |no |float |The altitude, in millimeters, above ground level
|===
