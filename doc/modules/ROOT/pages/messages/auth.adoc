...
[source,json]
----
include::example$request_AUTH-INF.json[]
----
...
[source,json]
----
include::example$response_AUTH-INF.json[]
----
...
authentication attempts, the server will return an object where the `result`
...
[source,json]
----
include::example$request_AUTH-WHOAMI.json[]
----
