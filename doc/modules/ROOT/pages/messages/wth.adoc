...
== `WTH-AT` - Current weather at a given geographical coordinate.
...
[source,json]
----
include::example$request_WTH-AT.json[]
----
...
[source,json]
----
include::example$response_WTH-AT.json[]
----
...
[source,json]
----
include::example$request_WTH-INF.json[]
----
...
[source,json]
----
include::example$response_WTH-INF.json[]
----
...
[source,json]
----
include::example$request_WTH-LIST.json[]
----
...
[source,json]
----
include::example$response_WTH-LIST.json[]
----
