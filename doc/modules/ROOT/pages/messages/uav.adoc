...
and the default behavior in such cases is to deny the operation. When the
...
operation; use this message only if the UAV is on the ground or if you are sure
...
A client sends this request to the server to request some of the UAVs to
