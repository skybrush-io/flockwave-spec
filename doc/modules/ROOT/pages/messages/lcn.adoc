...
`hwid`:: restricts the usage of the license to machines with certain hardware IDs.
The parameters object MUST contain a key named `ids` whose value is a list of hardware
IDs.
