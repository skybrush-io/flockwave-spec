...
|===
|Name |Required? |Type |Description
|`loaded` |yes |list of strings |List containing the identifiers of the extensions that are currently loaded and used by the server

|`available` |yes |list of strings |List containing the identifiers of the extensions that are currently not loaded by the server but could be loaded upon request
